...
mosquitto_pub -m "{\"time\":\"$(date '+%s')\",\"iid\":\"test_id\", \"metric\" : \"test_metric\", \"value\" : \"invalid time 1\"}"  -t "iiot/company/public/test/metrics"
echo "Publishing invalid time 2...."
mosquitto_pub -m "{\"time\":\"$(date '+%s')$(date '+%N')\",\"iid\":\"test_id\", \"metric\" : \"test_metric\", \"value\" : \"invalid time 2\"}"  -t "iiot/company/public/test/metrics"
